...
function AdminRouter() {
    ...
    return (
        <div className={'h-screen flex'}>
            ...
            <main className={'min-w-0 flex-1 overflow-x-hidden px-4 pt-4 pb-[calc(4rem+env(safe-area-inset-bottom))] sm:px-6 sm:pt-6 md:pb-6 lg:px-10 lg:pt-8 xl:px-16 xl:pt-12'}>
