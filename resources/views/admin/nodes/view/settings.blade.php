                    ...
                    <div class="col-xs-12">
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <p class="text-muted"><small>Enter the directory where server files should be stored. Common values: <code>/var/lib/pterodactyl/volumes</code>, <code>/var/lib/Jexactyl/volumes</code>, or <code>/home/daemon-data</code> (for OVH).</small></p>
                            </div>
                        </div>
                        <div class="row">
